...
json_mode_agent.print_response("Dubai 2050 - For a futuristic heist movie", stream=True)
structured_output_agent.print_response("Dubai 2050 - For a futuristic heist movie", stream=True)
